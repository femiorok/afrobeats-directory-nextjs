  ...
  return (
    <div className="landingcontainer h-screen w-screen bg-cover bg-bottom flex flex-col items-center justify-center "> 
      <h1 className="font-extrabold text-white text-5xl text-center sm:text-5xl md:text-5xl lg:text-7xl md:leading-tight">
        Afrobeats <span className=" bg-clip-text text-transparent bg-gradient-to-tl from-red-800 via-yellow-600 to-yellow-500" >Encyclopedia</span>
      </h1>
      ...
      <a href="/top-200-ng" className="relative p-0.5 inline-flex items-center justify-center font-bold overflow-hidden group rounded-md">
      ...
      <span className="relative text-white">Top 200 Songs Nigeria</span>
      </span>
      </a>
      <a href="/playlists" className="relative p-0.5 inline-flex items-center justify-center font-bold overflow-hidden group rounded-md">
      <span className="w-full h-full bg-gradient-to-br from-red-800 via-yellow-600 to-yellow-500 group-hover:from-red-800 group-hover:via-yellow-600 group-hover:to-yellow-500 absolute"></span>
      <span className="relative px-6 py-3 transition-all ease-out bg-gray-900 rounded-md group-hover:bg-opacity-0 duration-400">
      <span className="relative text-white">Explore Popular Playlists</span>
      </span>
      </a>
